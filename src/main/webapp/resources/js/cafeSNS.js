  ...
  function showPosition(position) {
    ...
    for (let i = 0; i < list.length; i++) {
      let distance = getdistance(
        latitude,
        longitude,
        list[i].storesDTO.store_latitude,
        list[i].storesDTO.store_longitude,
        "K"
      );
          ...
          $(data.lists).each(function (index, data) {
            ...
            if (data.imageDTO.image_save != null) {
              ...
              tableData +=
                ...
                "<p>다이아</p>" +
                '<input type="hidden" id="review_idx" value="' +
                data.review_idx +
                '"/>' +
                "</div>" +
                "</span>" +
                ...
                '<span id="cafename">' +
                "<b>" +
                data.storesDTO.store_name +
                "</b> </span>" +
                '<i class="far fa-heart fa-lg"' +
                'id="heart"' +
                'onclick="heart(this)"></i>' +
                '<span name="like" id="like" onclick="like(this,' +
                data.review_idx +
                ')">' +
                '<i class="far fa-thumbs-up fa-lg" id="thumb" style="color:' +
                color +
                ' ;"  ></i>' +
                '<small name="hit" id="hit">' +
                data.like_hit +
                "</small></span></div></div>" +
                '<div class="info">' +
                '<div class="txt">' +
                data.review_content +
                "</div>" +
                '<span style="color: grey; font-size: 14px">별점:' +
                data.review_star +
                "</span>" +
                "</div>" +
                "<br />" +
              ...
              tableData +=
                ...
                '<input type="hid den" id="review_idx" value="' +
                data.review_idx +
                '"/>' +
                '<img src="https://i.pinimg.com/236x/ec/f0/a1/ecf0a1fff1ddf788883644722b57d82c.jpg"/>' +
                '<span id="cafename">' +
