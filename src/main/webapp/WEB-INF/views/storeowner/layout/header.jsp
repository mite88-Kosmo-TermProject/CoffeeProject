	...
	<c:if test="${! empty UserID}">
		...
		<aside id="layout-menu"
			...
			<div class="app-brand demo">
				<a href="<%= request.getContextPath() %>/storeowner/index.do"
			...
			<ul class="menu-inner py-1">
				...
				<li class="menu-item active"><a
					href="<%= request.getContextPath() %>/storeowner/index.do"
					class="menu-link"> <i
				...
				<li class="menu-item"><a href="javascript:void(0);"
					...
					<ul class="menu-sub">
						<li class="menu-item"><a
							href="<%= request.getContextPath() %>/storeowner/cafe/edit.do"
							class="menu-link"> 카페정보 </a></li>

						<li class="menu-item"><a
							href="<%= request.getContextPath() %>/storeowner/storeOwnerSub/list.do"
				...
				<li class="menu-item"><a href="javascript:void(0);"
					...
					<ul class="menu-sub">
						<li class="menu-item"><a
							href="<%= request.getContextPath() %>/storeowner/selng/list.do"
							class="menu-link"> 매출관리 </a></li>

						<li class="menu-item"><a
							href="<%= request.getContextPath() %>/storeowner/excclc/list.do"
				...
				<li class="menu-item"><a
					href="<%= request.getContextPath() %>/storeowner/report/list.do"
					class="menu-link"> <i class="menu-icon tf-icons bx bx-layout"></i>
						리뷰신고관리
				</a></li>
						...
						<li class="nav-item navbar-dropdown dropdown-user dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-end">
								...
								<li><a class="dropdown-item"
									href="<%= request.getContextPath() %>/storeowner/member/view.do">
