...
<link href="<%=request.getContextPath()%>/resources/assets/js/login.js"
	rel="stylesheet">
<meta charset="utf-8">
...
<body>
		...
		<div class="container">
			<div class="row g-4">
				...
				<g class="body">
					...
					<path fill="none" stroke="#ab7442" stroke-width="2.5"
				...
				<g class="earL">
					<g class="outerEar" fill="#ddf1fa" stroke="#ab7442"
										stroke-width="2.5">
					...
					<g class="earHair">
						...
						<path
										...
										fill="#fff" stroke="#ab7442" stroke-width="2.5"
										stroke-linecap="round" stroke-linejoin="round" />
					</g>
				</g>
				<g class="earR">
				...
				<g class="eyebrow">
					...
					<path fill="#FFFFFF" stroke="#ab7442" stroke-width="2.5"
										stroke-linecap="round" stroke-linejoin="round"
				...
				<g class="eyeL">
					<circle cx="85.5" cy="78.5" r="3.5" fill="#ab7442" />
					<circle cx="84" cy="76" r="1" fill="#fff" />
				</g>
				<g class="eyeR">
					<circle cx="114.5" cy="78.5" r="3.5" fill="#ab7442" />
				...
				<g class="mouth">
					...
					<path style="display: none;" class="mouthLargeBG"
										...
										fill="#617e92" stroke="#ab7442" stroke-linejoin="round"
										stroke-width="2.5" />
					<defs>
					...
					<path class="mouthOutline" fill="none" stroke="#ab7442"
				...
				<g class="arms" clip-path="url(#armMask)">
					<g class="armL">
						<path fill="#ddf1fa" stroke="#ab7442" stroke-linecap="round"
						...
						<path fill="#fff" stroke="#ab7442" stroke-linecap="round"
	...
	<!-- partial -->
	<script src='http://abdu.space/TweenMax.min.js'></script>
