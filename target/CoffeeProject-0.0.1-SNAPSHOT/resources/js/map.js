...
function searchPlaces() {
	...
	/*var category = document.querySelector('.frmInp input');
	let result = '';
	if (category.target.checked) {
		result = category.target.value;
	} else {
		result = '';
	}
...
function displayPlaces(places) {
	...
	var listEl = document.getElementsByClassName('mapSearchList')[0],
		//menuEl = document.getElementById('menu_wrap'),
		menuEl = document.getElementsByClassName('resultArea')[0],
...
function getListItem(index, places) {
	...
	var el = document.createElement('li'),
		itemStr = '<a href="https://cafe.jejupass.com/web/cafe/761" role="button">' +
			'<figure>' +
			'<img src="https://static-file.jejupass.com/download/768531?width=120&amp;height=120" alt="">' +
			'</figure>' +
			'<div class="inner">' +
			'<strong class="titDep3">' + places.place_name + '</strong>' +
			'<span class="" locationinfo"="" title="위치 정보">' +
			...
			'<span class="icoScore" title="평균 평점">4.9<i title="리뷰 갯수">(5)</i></span>' +
			'</div>' +
	...
	//위도 , 경도
	el.setAttribute('lat', places.y);
	el.setAttribute('lng', places.x);
...
//카테고리 검색시..
/*$(".frmInp label").on("click", function() {
	alert("!!");
	searchPlaces();
});*/
